...
await conn.relayMessage(m.chat, { reactionMessage: { key: m.key, text: '✅'  }}, { messageId: m.key.id }) 
 ...
 let ihu = 'https://telegra.ph/file/30ab63b8f670bebb2ffdf.jpg'
 conn.sendMessage(m.chat, {
      video: { url: "https://telegra.ph/file/0ed236175a0aaea85c808.mp4"},
      gifPlayback: true,
      caption: text,
      contextInfo: {
      externalAdReply: {
